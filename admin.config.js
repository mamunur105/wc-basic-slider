 ...
 *
 * @package bsfw_Gallery
 */

module.exports = {
	// Project options.
	projectName    : 'wc-basic-slider',
	...
	// Translation options.
	textDomain            : 'wc-basic-slider',            // Your text-domain here.
	translationFile       : 'wc-basic-slider.pot',        // Name of the translation file.
	translationDestination: './languages',                      // Where to save the translation files.
	packageName           : 'WC Slider',                    // Package name.
	bugReport             : 'https://admin.com/',             // Where can users report bugs.
	lastTranslator        : 'admins <info@admin.com>',      // Last translator Email ID.
	team                  : 'admins <support@admin.com>',   // Team's Email ID.
