...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    /*global bs_slider */
    $('.post-type-bs_slider #titlediv').find('#title').after( // eslint-disable-next-line camelcase
    "<h3 style=\"margin-bottom:0;\">ShortCode</h3><div class=\"tooltip\"><span class=\"copy-button\" ><span class=\"tooltiptext\" >Copy to clipboard</span><input class=\"copy_shortcode\" type=\"text\" value=\"[woocategory_slider slider_id='".concat(bsfw_script.post_id, "']\" readonly></span></div>"));
...
/******/ 		var installedChunks = {
/******/ 			"/assets/scripts/admin": 0,
/******/ 			"assets/styles/frontend": 0,
...
/******/ 	__webpack_require__.O(undefined, ["assets/styles/frontend","assets/styles/admin"], () => (__webpack_require__("./src/scripts/admin.js")))
/******/ 	__webpack_require__.O(undefined, ["assets/styles/frontend","assets/styles/admin"], () => (__webpack_require__("./src/styles/admin.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["assets/styles/frontend","assets/styles/admin"], () => (__webpack_require__("./src/styles/frontend.scss")))
