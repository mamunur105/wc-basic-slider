...
class Shortcode {
	...
	public function __construct() {
		add_shortcode( 'bs_slider', array( $this, 'main_slider_shortcode' ) );
		add_shortcode( 'woocategory_slider', array( $this, 'woocategory_slider' ) );
	}
	/**
	 ...
	 * @return string
	 */
	public function main_slider_shortcode( $atts, $content ) {
	 ...
	 * @return void
	 */
	public function woocategory_slider( $atts, $contant ) {
		$slider    = shortcode_atts(
			array(
				'slider_id' => '',
			),
						...
						<div class="swiper-wrapper">
							...
							foreach ( $category_slider as $value ) {
								...
								?>
									...
									<?php
									echo esc_attr( $content_position ) . ' ';
									echo esc_attr( apply_filters( 'categpry_slider', 'slider_content_class' ) );
									?>
									">
